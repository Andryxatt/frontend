        ...
        <FormProvider {...methods}>
            <form className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                    <CustomInput label="Назва" type="text" id="name" placeholder="Назва"
                        validation={{
                            required: {
                                value: true,
                    ...
                    <CustomInput label="Номер моделі" type="text" id="modelNumber" placeholder="Номер моделі"
                        validation={{
                            required: {
                                value: true,
                                message: 'Обов’язкове поле',
...
//     } = useGetSubCategoriesQuery(undefined, { refetchOnMountOrArgChange: true }) as any
//     const {
//         data: colores,
